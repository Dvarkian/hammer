...
export const MODEL_TAGS = {
  ...
  'claude-fable-5': ['coding', 'general'],
  'claude-fable-5.1': ['coding', 'general'],
  'claude-haiku-4.5': ['fast', 'general'],
  'claude-sonnet-4.5': ['coding', 'general'],
  'claude-sonnet-5': ['coding', 'general'],
  ...
  'gpt-4.1': ['general'],
  'gpt-5.1-codex': ['coding', 'agentic'],
  'gpt-5.1-codex-max': ['coding', 'agentic'],
  'gpt-5.1-codex-mini': ['coding', 'fast'],
  'gpt-5-codex': ['coding', 'agentic'],
  'codex-mini-latest': ['coding', 'fast'],
  'gpt-5.5': ['general', 'reasoning'],
  'gemini-3.1-pro-preview': ['reasoning', 'general'],
  'gemini-3-flash-preview': ['fast', 'general'],
  'grok-4.5': ['general', 'agentic'],
  ...
  'kimi-k3': ['agentic', 'coding', 'general'],
