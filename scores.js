/**
 * @file scores.js
 * @description Offline model-quality fallbacks used only when the live OpenRouter
 * catalog has no match or cannot be reached. Runtime ranking prefers Artificial
 * Analysis coding index, then Design Arena and metadata estimates.
 * Current online-model fallback values refreshed 2026-08-02.
...
export const scores = {
  ...
  "deepseek-v4-flash": 0.521,
  "deepseek/deepseek-v4-flash-0731": 0.691,
  ...
  "google/gemma-4-26b-a4b-it": 0.393,
  ...
  "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning": 0.138,
  "nvidia/nemotron-3-nano-30b-a3b": 0.43,
  "nvidia/nemotron-3-super-120b-a12b": 0.377,
  ...
  "qwen-3-235b-a22b-instruct-2507": 0.7,
  "qwen-3-32b": 0.5,
  "qwen-qwq-32b": 0.5,
  ...
  "xiaomi/mimo-v2.5": 0.568,
  "inclusionai/ling-3.0-flash": 0.608,
  "moonshotai/kimi-k3": 0.762,
