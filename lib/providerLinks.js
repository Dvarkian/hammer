 ...
 *
 * This table used to be hand-maintained here and had drifted: `freemodels` had no entry
 * (it genuinely has no key to obtain), and nothing tied an entry to the provider it
 * described. It is now derived from the provider descriptors, so a provider's signup
