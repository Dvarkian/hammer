...
//
// Deliberately about balance and funds and *not* about credits alone: Pollinations' free pollen
// allowance — "the account behind this API key doesn't have enough credits. Please top up or
// complete a quest, then try again." — is the allowance a quest refills, so it stays on the
// clock where it has always been instead of becoming a wall this predicate cannot see past.
