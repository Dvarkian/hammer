...
const METRIC_FIELDS = {
  ...
  credits: {
    ...
    // A bare `balance` is a remaining amount, never a limit or a spend: some providers
    // answer with the caller's remaining credit balance, and reading it as anything else
    // would draw the wrong end of the bar.
