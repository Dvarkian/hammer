 ...
 *
 * `rejectsUnknownFields` is on for Groq because its validator is OpenAI-strict:
 * it refuses any message key outside the contract. The observed refusal that put
 * it here:
 ...
 */
export const SEEDED_FIELD_STRIPS = {
