...
/** Free rows marked by a trailing `-free` id. */
export const OPENCODE_PROVIDER_KEY = 'opencode'
...
/** Keyless by design: an Authorization header moves it onto Cloudflare's bot path. */
export const FREEMODELS_PROVIDER_KEY = 'freemodels'
