 ...
 * sense for one provider — NVIDIA's account-scoped 404, Google's api-version 404, g4f's
 * unsupported-model 404 — collected here so the classifier can consult them without
 * knowing which provider it is looking at.
 *
 * @param {string} key
