 ...
 * differently: KiloCode flags free rows with `isFree`, OpenCode Zen marks them with a
 * trailing `-free`, Ollama serves `/api/tags` plus a per-model `/api/show`, Empero and the
 ...
 *
 * This used to be a hardcoded set (kilocode, opencode, empero, freemodels, gptfree). That
